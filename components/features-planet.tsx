          ...
          <div className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 [&>*]:relative [&>*]:p-6 [&>*]:before:absolute [&>*]:before:bg-gray-800 [&>*]:before:[block-size:100vh] [&>*]:before:[inline-size:1px] [&>*]:before:[inset-block-start:0] [&>*]:before:[inset-inline-start:-1px] [&>*]:after:absolute [&>*]:after:bg-gray-800 [&>*]:after:[block-size:1px] [&>*]:after:[inline-size:100vw] [&>*]:after:[inset-block-start:-1px] [&>*]:after:[inset-inline-start:0] md:[&>*]:p-10">
            <article>
              ...
              <p className="text-[15px] text-gray-400">
                Dive into a high-energy environment where innovation thrives.
                Whether you're a coder, designer, or problem-solver, this is
                your chance to think outside the box and bring your boldest
                ideas to life.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Collaborate with the Best</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Work alongside talented individuals from diverse backgrounds.
                Forge new connections, learn from others, and build something
                extraordinary as a team. Who knows? Your next co-founder or
                mentor might be right beside you!
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
                Tackle meaningful challenges that have the potential to make a
                real impact. From sustainability to tech innovation, your
                solutions could shape the future and leave a lasting legacy.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
                Gain insights from seasoned mentors, judges, and speakers who
                are leaders in their fields. Get hands-on guidance, feedback,
            ...
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Fuel Your Passion</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Immerse yourself in a vibrant community of like-minded
                innovators. Whether you're a seasoned hacker or a first-timer,
                this is your chance to grow, experiment, and have fun while
                doing what you love.
              </p>
            </article>
            <article>
              ...
              <p className="text-[15px] text-gray-400">
                Showcase your skills and creativity by building a project that
                stands out. Whether it's for your resume, LinkedIn profile, or
                personal portfolio, this hackathon is your chance to shine and
                catch the eye of potential employers, investors, or
                collaborators.
              </p>
            </article>
          </div>
